...
function cadMsg(){
	 ...
	 if(isset($_GET['cadastro'])){
		...
		if($_GET['cadastro'] == 'true'){
			...
			echo '<h1 class="mt-5 p-3 contain text-light text-center" style="background-color: #FF4500; width: 56.2%;">Os campos não podem ficar vázios</h1>';
...
function cadTipoMsg(){
	if(isset($_GET['cadastro'])){
		...
		if($_GET['cadastro'] == 'true'){
			...
			echo '<h1 class="mt-5 p-3 contain text-light text-center" style="background-color: #FF4500; width: 56.2%;">O campo não pode ficar vázio</h1>';

		} else if($_GET['cadastro'] == 'exist') {
			echo '<h1 class="mt-5 p-3 contain text-light text-center" style="background-color: #001023; width: 56.2%;">Dispositivo já Cadastrado</h1>';
